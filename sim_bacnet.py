...
# ------------------------------
# Crear objetos BACnet simulados
# ------------------------------
...
temp_setpoint = AnalogValueObject(
    objectIdentifier=("analogValue", 1),
    objectName="TempSetpoint",
    presentValue=21.0
)

humidity_setpoint = AnalogValueObject(
    objectIdentifier=("analogValue", 2),
    objectName="HumiditySetpoint",
    presentValue=50.0
)

pump = BinaryValueObject(
    objectIdentifier=("binaryValue", 1),
    objectName="PumpStatus",
    presentValue=1
)

valve_status = BinaryValueObject(
...
# ------------------------------
# Crear aplicación BACnet pero NO ejecutarla
# ------------------------------
...
for obj in [
    ...
    valve, fan_speed,
    temp_setpoint, humidity_setpoint,
    pump, valve_status
]:
    app.add_object(obj)
